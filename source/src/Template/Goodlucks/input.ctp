        ...
        <div class="inner">
            <div class="form-wrapper">
                <div class="note-area">
                    ...
                    <p>みなさんと一緒に作るメッセージ集で、気持ち良く愛美を送り出してあげられたらいいなと思っています。</p>
                    ...
                    <div class="attention">
                        <ul>
                            ...
                            <li>もし周りにまだメッセージを送っていない友人・知り合いの方がいましたら、アクセスパスワードと共にぜひこのサイトを共有してください。</li>
                            <li style="color:red;">サプライズのつもりですので、このサイトのことは絶対に本人に内緒でお願い致します。</li>
                        </ul>
                    </div>
                </div>
                <!-- /.note-area -->
